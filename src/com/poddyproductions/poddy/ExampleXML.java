...
public static String exampleXML = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
		...
		+ "	<description>Der Podcast über Raumfahrt von ESA und DLR - mit Tim Pritlove</description>"
		...
		+ "	<itunes:summary>Raumzeit ist eine Serie von Gesprächen mit Wissenschaftlern, Ingenieuren und anderen Machern von DLR und ESA über Raumfahrt. Jede Episode rückt einen Themenbereich in den Fokus und diskutiert ausführlich alle Aspekte und Details.</itunes:summary>"
		...
		+ ""
		+ "		<itunes:subtitle>Nachdem wir in der letzten Raumzeit die Herausforderungen eines Fluges zur Venus besprochen haben, rücken wir in dieser Ausgabe den Planeten selbst in den Mittelpunkt: die Venus. Der „höllische Nachbar der Erde“,</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Die Venus ist trotz ihrer Nähe zur Erde ein vergleichsweise wenig erforschter Planet, der die Wissenschaft aber trotzdem vor große Fragen und die Raumfahrt vor große Herausforderungen stellt: die extreme Atmosphäre des Planeten verspricht Erkenntnisse ...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Eine gute Ausbildung spielt in der Raumfahrt eine große Rolle &#8211; und so engagieren sich DLR und ESA auch darin, Studenten noch während des Studiums eine Vielzahl von Einstiegsmöglichkeiten zu geben. Das DLR bietet dabei Studententeams sogar die Möglichkeit, eigene &#8230; <a href=\"http://raumzeit-podcast.de/2012/08/31/rz045-rexus-bexus/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Eine gute Ausbildung spielt in der Raumfahrt eine große Rolle - und so engagieren sich DLR und ESA auch darin, Studenten noch während des Studiums eine Vielzahl von Einstiegsmöglichkeiten zu geben. Das DLR bietet dabei Studententeams sogar die Möglichk...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Der Merkur stellt die Wissenschaft noch vor große Rätsel. Trotzdem haben die Mariner- und MESSENGER-Missionen für einen grundlegenden Erkenntnisgewinn gesorgt. Die in der letzten Raumzeit-Folge besprochene Mission BepiColombo soll in naher Zukunft die Grundlage für weitere Forschungserfolge schaffen. Anhand der &#8230; <a href=\"http://raumzeit-podcast.de/2012/08/17/rz044-der-merkur/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Der Merkur stellt die Wissenschaft noch vor große Rätsel. Trotzdem haben die Mariner- und MESSENGER-Missionen für einen grundlegenden Erkenntnisgewinn gesorgt. Die in der letzten Raumzeit-Folge besprochene Mission BepiColombo soll in naher Zukunft die ...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Der Merkur hat im Vergleich zu anderen Planeten bislang eher selten Besuch von der Menschheit erhalten. Die Gründe dafür sind offensichtlich: die Nähe des Himmelskörpers zur Sonne stellt die Raumfahrt vor große Herausforderungen, da ihre Hitze und Gravitation einen Anflug &#8230; <a href=\"http://raumzeit-podcast.de/2012/08/03/rz043-bepicolombo/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Der Merkur hat im Vergleich zu anderen Planeten bislang eher selten Besuch von der Menschheit erhalten. Die Gründe dafür sind offensichtlich: die Nähe des Himmelskörpers zur Sonne stellt die Raumfahrt vor große Herausforderungen,</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Die Erdbeobachtung ist heutzutage eine der wichtigsten Aufgaben der Raumfahrt, ist sie doch die Basis der Umweltforschung als auch zunehmend entscheidende Informationsquelle für die Landwirtschaft und viele andere Anwendungen hinaus. - </itunes:subtitle>"
		...
		+ "		<slash:comments>6</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Der Erdbeobachtungssatellit Envisat war nicht nur einer der größten seiner Art, er war auch ein Tausendsassa in seiner Disziplin. In seiner zehnjährigen Betriebsphase - doppelt so lang wie ursprünglich geplant -  hat er die Erdbeobachtung maßgeblich ge...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Die Vermessung der Welt ist keine leichte Aufgabe, da es sich bei der Erde um ein Objekt permanenter Bewegung handelt. Flüssiges Magma im Inneren und schwimmende Kontinente auf dem Erdmantel formen die Gestalt der Erde und bestimmen das Erdschwerefeld, das &#8230; <a href=\"http://raumzeit-podcast.de/2012/06/22/rz040-goce/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Die Vermessung der Welt ist keine leichte Aufgabe, da es sich bei der Erde um ein Objekt permanenter Bewegung handelt. Flüssiges Magma im Inneren und schwimmende Kontinente auf dem Erdmantel formen die Gestalt der Erde und bestimmen das Erdschwerefeld,</itunes:subtitle>"
		...
		+ "		<slash:comments>9</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Manche Planeten haben viele, manche haben keine, die Erde hat nur einen: einen Mond. Der Erdmond ist der nächste Himmelskörper und der einzige, der bisher von Menschen erreicht wurde. Der Mond ist Forschungsobjekt und Traumgestalt in einem und hat die ...</itunes:subtitle>"
		+ "		<itunes:summary>Manche Planeten haben viele, manche haben keine, die Erde hat nur einen: einen Mond. Der Erdmond ist der nächste Himmelskörper und der einzige, der bisher von Menschen erreicht wurde. Der Mond ist Forschungsobjekt und Traumgestalt in einem und hat die Menschheit seit jeher fasziniert."
		+ ""
		...
		+ ""
		+ "		<itunes:subtitle>In den letzten zehn Jahren hat sich das Verständnis des Universums grundlegend gewandelt. Durch zahlreiche wissenschaftliche Entdeckungen und Erkenntnisse wurden die bisherigen Annahmen auf den Kopf gestellt.</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Die Doppelmission TerraSAR-X und TanDEM-X besticht durch ihre ungewöhnliche Konstellation und technische Innovation in der Satellitensteuerung. Zunächst als einfache Radarmission unter dem Namen TerraSAR-X geplant,</itunes:subtitle>"
		...
		+ "		<slash:comments>10</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Das Deutsche Raumfahrt-Kontrollzentrum (GSOC) mit seinem Hauptsitz in Oberpfaffenhofen ist für die Steuerung von Raumfahrzeugen aller Art zuständig und begleitet unter anderem die Columbus-Mission an Bord der ISS sowie zahlreiche Erdbeobachtungssatelli...</itunes:subtitle>"
		...
		+ "		<slash:comments>9</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Technologietransfer verbindet Raumfahrtforschung und Wirtschaft indem es eine bidirektionale Brücke zwischen diesen Entitäten baut. Der Transfer von Wissen und Forschungsergebnissen in die Wirtschaft verspricht in der Zukunft eine ökonomischere Nutzung...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Der Bedarf an einer umfassenden Beobachtung und Katalogisierung der unmittelbaren Umgebung der Erde im Weltraum wird täglich größer.  Zunehmender Satellitenverkehr und Weltraumschrott aber auch wechselnde Sonnenaktivität und erdnahe Asteroiden erforder...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Der Umbau unserer Energieversorgung schreitet weltweit stärker voran als sich dies aus der eigenen Betrachtung und Nachrichtenlage ablesen lässt. Besonders die ursprünglich für die Bedürfnisse der Raumfahrt entwickelte Photovoltaik und besonders die Solarthermie spielen hier eine zentrale Rolle. Doch für &#8230; <a href=\"http://raumzeit-podcast.de/2012/03/09/rz033-energie-der-zukunft/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Der Umbau unserer Energieversorgung schreitet weltweit stärker voran als sich dies aus der eigenen Betrachtung und Nachrichtenlage ablesen lässt. Besonders die ursprünglich für die Bedürfnisse der Raumfahrt entwickelte Photovoltaik und besonders die So...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Nachdem wir bereits in der 30. Ausgabe von Raumzeit die technischen und organisatorischen Aspekte der Mission Cassini-Huygens im Detail besprochen haben, geht die aktuelle Ausgabe unserer Gesprächsserie auf die wissenschaftlichen Erkenntnisse über das ...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Die DLR_School_Labs sind eine Nachwuchsförderungsinitiative des DLR und sind in neun Städten teils an DLR-Standorte, teils an Universitäten angeschlossen. In den Schülerlaboren wird Schülern die Möglichkeit gegeben,</itunes:subtitle>"
		...
		+ "	<itunes:subtitle>Wie ja schon in Ausgabe RZ026 Forschen in Schwerelosigkeit bekannt wurde, war Raumzeit-Moderator Tim Pritlove für uns beim 18. DLR-Parabelflug mit an Bord und hat sein Erlebnis dort in Bild und Ton festgehalten.</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Deep Space Missionen gehören zu den größten Herausforderungen der Raumfahrt, da hier stets Neuland betreten wird und die technischen und organisatorischen Anforderungen extrem sind. Reisen zu den Gasplaneten unseres Sonnensystems sind dabei besonders s...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Das Infrarot-Weltraumteleskop Herschel wurde gemeinsam mit dem Schwester-Satelliten Planck 2009 gestartet und erreichte zwei Monate später seinen Aufenthaltspunkt auf der Erd-Sonnen-Achse ca. 1,5 Millionen Kilometer von unserem Planeten entfernt. Von dort beobachtet Herschel den Weltraum im Infrarotteleskop mit dem größten &#8230; <a href=\"http://raumzeit-podcast.de/2011/12/02/rz029-herschel-weltraumteleskop/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ "	<itunes:subtitle>Das Infrarot-Weltraumteleskop Herschel wurde gemeinsam mit dem Schwester-Satelliten Planck 2009 gestartet und erreichte zwei Monate später seinen Aufenthaltspunkt auf der Erd-Sonnen-Achse ca. 1,5 Millionen Kilometer von unserem Planeten entfernt.</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Raumfahrtmissionen erfordern eine permanente und zuverlässige Steuerung und Kommunikation mit der Erde. Diesen Kontakt halten eine Vielzahl von Bodenstationen, die auf unterschiedlichen Frequenzbändern die Aktivität im Orbit und im Deep Space beobachte...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Langzeitaufenthalte im All haben ihre ganz eigenen Anforderungen und eine mögliche bemannte Mission zum Mars stellt die internationale Raumfahrt vor ganz neue Fragestellungen sowie organisatorische und vor allem medizinisch-psychologische Herausforderu...</itunes:subtitle>"
		...
		+ "		<slash:comments>9</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Das Experimentieren in Schwerelosigkeit gibt Forschern in vielen Disziplinen die Möglichkeit, Vorgänge und Materialien auf eine Weise zu testen, die auf der Erde normalerweise nicht möglich ist. Wissenschaftler können dabei Nebeneffekte isolieren und i...</itunes:subtitle>"
		...
		+ "		<item>"
		+ "		<title>RZ025 Zentrum für Kriseninformation</title>"
		...
		+ "		<description><![CDATA[Das Zentrum für satellitengestützte Kriseninformation (ZKI) des DLR ist eine Diensleistungseinrichtung zur Unterstützung von Staaten, Einsatzkräften oder Hilfsorganisationen bei der Bewältigung von Naturkatastrophen und anderen große Gebiete betreffene Krisen, bei denen eine Aufklärung durch Erdbeobachtungssysteme hilfreich sein kann. Das ZKI &#8230; <a href=\"http://raumzeit-podcast.de/2011/10/14/rz025-zentrum-fur-kriseninformation/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ "		<slash:comments>5</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Das Zentrum für satellitengestützte Kriseninformation (ZKI) des DLR ist eine Diensleistungseinrichtung zur Unterstützung von Staaten, Einsatzkräften oder Hilfsorganisationen bei der Bewältigung von Naturkatastrophen und anderen große Gebiete betreffene...</itunes:subtitle>"
		...
		+ "		<slash:comments>13</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Die Röntgenastronomie hat in den 70er Jahren vollkommen neue Einblicke ins All ermöglicht und trug in erheblichem Maße zum heutigen Basiswissen über unser Universum bei. Die ROSAT-Mission - unter Federführung des Max-Planck-Instituts für extraterrestri...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Leopold Summerer (ESA) erläutert die Forschungsarbeit des Advanced Concepts Team der ESA am ESTEC in Nordwijk (NL). Er stellt verschiedene Projekte vor und erklärt, auf welche Art und Weise die Ergebnisse die Arbeit der Projektgruppen der ESA beeinflus...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Prof. Dr. Rupert Gerzer, Leiter des DLR-Instituts für Luft- und Raumfahrtmedizin, führt in die medizinischen Aspekte der Raumfahrt ein und erläutert die Zusammenhänge von Forschung und Betriebsanforderungen der bemannten Raumfahrt.</itunes:subtitle>"
		...
		+ "		<slash:comments>6</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Gerhard Schwehm - Rosetta Mission Manager und Head of Solar System Science Operations Division der ESA - erläutert die Geschichte der beiden ESA-Kometenmissionen und erzählt von den kommenden Herausforderungen  Rosetta-Mission.</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Volker Sobick, ehemaliger stellvertretender Leiter des bemannten Raumfahrtprogramms beim DLR, berichtet auf Basis seiner langjährigen Zusammenarbeit mit der NASA, von der bewegten Geschichte des Space Shuttle.</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Jörg Wehner, Chef des Technischen Netzwerks der ESA-Zentren in Europa, berichtet über das ESTEC Test Centre und stellt seine einzelnen Einrichtungen vor. <a href=\"http://raumzeit-podcast.de/2011/07/01/rz018-estec-test-centre/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Jörg Wehner, Chef des Technischen Netzwerks der ESA-Zentren in Europa, berichtet über das ESTEC Test Centre und stellt seine einzelnen Einrichtungen vor.</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Das Automated Transfer Vehicle (ATV) ist das Logistik-Raumfahrzeug der ESA für die Internationale Raumstation ISS. Nachdem im Frühjahr 2008 die erste ATV-Mission unter dem Namen &#8220;Jules Verne&#8221; erfolgreich abgeschlossen werden konnte wurde zwei Jahre später die Nachfolgemission &#8220;Johannes Kepler&#8221; gestartet &#8230; <a href=\"http://raumzeit-podcast.de/2011/06/17/rz017-automated-transfer-vehicle/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ "		<slash:comments>9</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Das Automated Transfer Vehicle (ATV) ist das Logistik-Raumfahrzeug der ESA für die Internationale Raumstation ISS. Nachdem im Frühjahr 2008 die erste ATV-Mission unter dem Namen \"Jules Verne\" erfolgreich abgeschlossen werden konnte wurde zwei Jahre spä...</itunes:subtitle>"
		...
		+ "		<slash:comments>27</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>SOFIA - das auf ein Flugzeug montierte Infrarot-Teleskop zur Beobachtung des Weltalls von der Stratosphäre aus - ist ein Gemeinschaftsprojekt des DLR und der NASA. Als Nachfolgesystem des bereits sehr erfolgreichen Kuiper Airborne Observatory (KAO) wur...</itunes:subtitle>"
		+ "		<itunes:summary>SOFIA - das auf ein Flugzeug montierte Infrarot-Teleskop zur Beobachtung des Weltalls von der Stratosphäre aus - ist ein Gemeinschaftsprojekt des DLR und der NASA. Als Nachfolgesystem des bereits sehr erfolgreichen Kuiper Airborne Observatory (KAO) wurde SOFIA unlängst in Betrieb genommen und erreicht aufgrund seiner größer dimensionierten Spiegel und aktueller Messtechnik deutlich gesteigerte Messwerte. Damit dient SOFIA der verbesserten Beobachtung des Weltalls und der Grundlagenforschung auf vielen Gebieten."
		+ ""
		...
		+ "		<description><![CDATA[Computer sind heute das Universalwerkzeug der Forschung und Software ist der Schlüssel zum Erfolg der Projekte. So wird Software auch selbst zum Forschungsgegenstand. Aber auch um in anderen Forschungsbereichen des DLR das Wissen um die erforderlichen und wünschenswerten Techniken in &#8230; <a href=\"http://raumzeit-podcast.de/2011/05/20/rz015-softwaretechnik/\">Continue reading <span class=\"meta-nav\">&#8594;</span></a>]]></description>"
		...
		+ ""
		+ "		<itunes:subtitle>Computer sind heute das Universalwerkzeug der Forschung und Software ist der Schlüssel zum Erfolg der Projekte. So wird Software auch selbst zum Forschungsgegenstand. Aber auch um in anderen Forschungsbereichen des DLR das Wissen um die erforderlichen ...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Robotik ist eine noch verhältnismäßig junge technische Disziplin und steht in der Raumfahrt selbst noch vor dem Durchbruch. Erstmals kam im Rahmen der D2-Mission auf dem Space Shuttle ein vom DLR geplantes Projekt auf einem Raumfahrtzeug zum Einsatz.</itunes:subtitle>"
		...
		+ "		<item>"
		+ "		<title>RZ013 Die Atmosphäre</title>"
		...
		+ "		<slash:comments>9</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Unsere Erde ist von einer verhältnismäßig dünnen Schicht von Gasen umgeben, die das Leben auf der Erde überhaupt erst ermöglicht, indem sie Temperatur und Klima schafft und Schutz vor Strahlung bietet. Die Struktur der Atmosphäre hat aber auch große Au...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Vor fünzig Jahren, am 12. April 1961, passierte Juri Alexejewitsch Gagarin an Bord der Wostok 1 als erster Mensch die magische 100-Kilometer-Marke, ab der man vom Weltraum spricht. Damit war faktisch die moderne bemannte Raumfahrt geboren.</itunes:subtitle>"
		...
		+ "		<slash:comments>20</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Astronauten müssen für ihre Einsätze über ein außergewöhnlich umfangreiches Grundwissen und Training verfügen, damit sie sowohl den Herausforderungen der täglichen Arbeit im Orbit als auch möglichen Notfallsituationen gewachsen sind.</itunes:subtitle>"
		...
		+ "		<slash:comments>22</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Raumstationen sind neben den großen interplanetaren Missionen die Aushängeschilder der Raumfahrt. Heute wirkt sie zudem als Bindeglied der internationalen Raumfahrtagenturen, von denen sich schon viele an den Aktivitäten der Mir und vor allem der Inter...</itunes:subtitle>"
		+ "		<itunes:summary>Raumstationen sind neben den großen interplanetaren Missionen die Aushängeschilder der Raumfahrt. Heute wirkt sie zudem als Bindeglied der internationalen Raumfahrtagenturen, von denen sich schon viele an den Aktivitäten der Mir und vor allem der Internationalen Raumstation ISS beteiligen. Die ESA stellt mit dem Columbus-Modul einen wichtigen Baustein der ISS."
		+ ""
		...
		+ "		<slash:comments>5</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Neben den großen Himmelskörpern wie Sonne und Planeten wird unser Sonnensystem auch durch eine Vielzahl von kleineren Objekten geprägt: Asteroiden und Kometen nehmen in der Mitte und am Rand des Systems breiten Raum ein und einige einzelne Vertreter sí...</itunes:subtitle>"
		...
		+ ""
		+ "		<itunes:subtitle>Satellitennavigation ist die vielleicht populärste Anwendung der Raumfahrt überhaupt. Seitdem die USA ihr GPS-System Anfang der 1990er Jahre für jeden nutzbar geschaltet haben, werden immer mehr Einsatzgebiete gefunden.</itunes:subtitle>"
		...
		+ "		<slash:comments>22</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Die Raumfahrt schießt seit Jahrzehnten beherzt neue Raumfahrzeuge in den Orbit und übersah anfangs ein heute bedrohliche Ausmaße annehmendes Problem: die Umlaufbahnen sind überfüllt mit Material und fortlaufend auftretende kleine und große Kollisionen ...</itunes:subtitle>"
		...
		+ "		<slash:comments>10</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Paradoxerweise ist die Erdbeobachtung eine der wichtigsten Aufgaben der Raumfahrt, da erst der Blick von oben der Menschheit das nötige Bewusstsein für das Große und Ganze und für die Verletzlichkeit unseres Planetens geschaffen hat.</itunes:subtitle>"
		...
		+ "		<slash:comments>22</slash:comments>"
		+ ""
		+ "		<itunes:subtitle>Nachdem wir in der dritten Ausgabe von Raumzeit uns ausführlich mit den Raketentriebwerken und dem Raketenstart beschäftigt haben, nimmt die aktuelle Sendung den Faden an der genau der Stelle auf und blickt auf den Bereich \"Operations\" der sich mit der...</itunes:subtitle>"
		+ "		<itunes:summary>Nachdem wir in der dritten Ausgabe von Raumzeit uns ausführlich mit den Raketentriebwerken und dem Raketenstart beschäftigt haben, nimmt die aktuelle Sendung den Faden an der genau der Stelle auf und blickt auf den Bereich \"Operations\" der sich mit der konkreten Steuerung der Raumfahrzeuge auseinandersetzt."
		+ ""
		...
		+ ""
		+ "		<itunes:subtitle>Um die Erdanziehung zu überwinden muss bei Raumfahrtmissionen eine Menge Energie freigesetzt werden. Um die notwendige Kraft zu entfalten müssen leistungsfähige und zuverlässige Antriebe entwickelt werden. Die dritte Ausgabe von Raumzeit widmet sich ga...</itunes:subtitle>"
		+ "		<itunes:summary>Um die Erdanziehung zu überwinden muss bei Raumfahrtmissionen eine Menge Energie freigesetzt werden. Um die notwendige Kraft zu entfalten müssen leistungsfähige und zuverlässige Antriebe entwickelt werden. Die dritte Ausgabe von Raumzeit widmet sich ganz diesem Thema."
		+ ""
		...
		+ ""
		+ "		<itunes:subtitle>Bevor irgendetwas ins All geschossen wird muss zunächst viel nachgedacht werden. Daher widmet sich die zweite Ausgabe von Raumzeit der Phase der Missionsplanung. - Missionsanalyst Markus Landgraf vom European Space Operations Center (ESOC) der ESA in ...</itunes:subtitle>"
		+ "		<itunes:summary>Bevor irgendetwas ins All geschossen wird muss zunächst viel nachgedacht werden. Daher widmet sich die zweite Ausgabe von Raumzeit der Phase der Missionsplanung."
		+ ""
		...
		+ ""
		+ "		<itunes:subtitle>Nun ist es so weit: die erste Ausgabe unseres Podcasts steht bereit. Um dem gesamten Themenkomplex einen Rahmen und eine ausführliche Einführung zu geben beginnen wir mit einem Gespräch mit Jan Wörner, Vorstandsvorsitzender des Deutschen Zentrums für L...</itunes:subtitle>"
		...
		+ "		<description><![CDATA[Eine kleine Einführung in unser Projekt als Appetithäppchen vorab, damit Ihr Euch schon mal mit unserer tollen Erkennungsmelodie bekannt machen könnt. Dauer: 00:03:03h]]></description>"
		+ "			<content:encoded><![CDATA[<p>Eine kleine Einführung in unser Projekt als Appetithäppchen vorab, damit Ihr Euch schon mal mit unserer tollen Erkennungsmelodie bekannt machen könnt.</p>"
		...
		+ ""
		+ "		<itunes:subtitle>Eine kleine Einführung in unser Projekt als Appetithäppchen vorab, damit Ihr Euch schon mal mit unserer tollen Erkennungsmelodie bekannt machen könnt. - Dauer: 00:03:03h</itunes:subtitle>"
		+ "		<itunes:summary>Eine kleine Einführung in unser Projekt als Appetithäppchen vorab, damit Ihr Euch schon mal mit unserer tollen Erkennungsmelodie bekannt machen könnt."
		+ ""
		...
		+ "	<copyright>http://creativecommons.org/licenses/by-nc-nd/3.0/de/</copyright><media:credit role=\"author\">Metaebene Personal Media</media:credit><media:rating>nonadult</media:rating><media:description type=\"plain\">Der Podcast über Raumfahrt von ESA und DLR – mit Tim Pritlove</media:description></channel>"
		+ "</rss>";
}
